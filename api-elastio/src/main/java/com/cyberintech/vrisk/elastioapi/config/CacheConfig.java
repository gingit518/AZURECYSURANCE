...
public class CacheConfig {
	...
	CacheManager getCacheManager() {
		...
		CacheEventListenerConfigurationBuilder asynchronousListener = CacheEventListenerConfigurationBuilder.newEventListenerConfiguration(cacheEventsLogger, EventType.CREATED, EventType.EXPIRED).unordered().asynchronous();
