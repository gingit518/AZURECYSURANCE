...
//			String accessToken = documentAccessTokensService.getSafeDocumentAccessToken(downloadAuthorizationToken);
//
...
//		} else if (StringUtils.isNotEmpty(requestAuthParameter)) {
//			MutableHttpServletRequest customRequest = new MutableHttpServletRequest(request);
