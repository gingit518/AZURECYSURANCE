...
public class JsonToUrlEncodedAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		...
		if (Objects.equals(request.getServletPath(), "/oauth/token") && (Objects.equals(request.getContentType(), "application/json") || StringUtils.containsIgnoreCase(request.getContentType(), "application/json"))) {
