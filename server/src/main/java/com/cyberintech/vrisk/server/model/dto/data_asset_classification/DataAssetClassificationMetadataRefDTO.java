...
public class DataAssetClassificationMetadataRefDTO extends DTOBase<DataAssetClassificationMetadata> {
	@Schema
	private Long id;
	@Schema
	private String key;
	...
	public DataAssetClassificationMetadataRefDTO(DataAssetClassificationMetadata metadata) {
		super(metadata);
	}
