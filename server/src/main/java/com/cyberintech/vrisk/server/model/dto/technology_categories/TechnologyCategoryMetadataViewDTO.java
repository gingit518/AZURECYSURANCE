...
public class TechnologyCategoryMetadataViewDTO extends DTOBase<TechnologyCategoriesMetadata> {
	@Schema
	private Long id;
	@Schema
	...
	public TechnologyCategoryMetadataViewDTO(TechnologyCategoriesMetadata technologyCategoriesMetadata) {
	...
	public void fromEntity(TechnologyCategoriesMetadata technologyCategoriesMetadata) {
		...
		this.technologyCategory = new TechnologyCategoryRefDTO(technologyCategoriesMetadata.getTechnologyCategory());
