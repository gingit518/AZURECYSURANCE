...
public enum VItemType {
	...
	, PACKAGE_PLAN(9101L, "Package Plan")
	, PERMISSIONS(9115L, "Permissions")
	, ROLE_PERMISSIONS(9116L, "Role Permissions")
	...
	, TECHNOLOGY_SUBCATEGORY(1143L, "Technology Category")
	, TECHNOLOGY_TYPE_CLASS(1145L, "Technology Category")
	...
	, POLICY(280L, "Policy")
	, POLICY_ANNUAL_REVIEW(28001L, "Policy Annual Review")
	...
	, SECURITY_AUDIT_COMMENT(385L, "Security Audit Comment")
	, RISK_MODEL_CONSTANT(386L, "Risk Model Constant")
	, HINT(387L, "Hints")
	, MENU_ITEM(388L, "Menu Items")
	, INDUSTRY(389L, "Industry")

	// Zoom Info integrations
	, ZOOM_INFO_ORGANIZATION_SYNC(1401L, "Zoom Info Organization Sync")
	, ZOOM_INFO_TECHNOLOGY_CATEGORY_SYNC(1402L, "Zoom Info Technology Category Sync")
	, ZOOM_INFO_TECHNOLOGY_SYNC(1403L, "Zoom Info Technology Sync")
	, ZOOM_INFO_SYSTEM_SYNC(1404L, "Zoom Info System Sync")
	, ZOOM_INFO_VENDOR_SYNC(1405L, "Zoom Info Vendor Sync")
	, ZOOM_INFO_BUSINESS_UNIT_SYNC(1406L, "Zoom Info Business Unit Sync")
	, ZOOM_INFO_SUBSIDIARY_ORGANIZATION_SYNC(1407L, "Zoom Info Subsidiary Organization Sync")

	// big id integrations
	, BIG_ID_SYSTEM_SYNC(2000L, "Big Id System Sync")
	, BIG_ID_USER_SYNC(2001L, "Big Id User sync")
	, BIG_ID_TECHNOLOGY_CATEGORY_SYNC(2002L, "Big Id Technology Category Sync")
	, BIG_ID_TECHNOLOGY_SYNC(2003L, "Big Id Technology Sync")
	, BIG_ID_DATA_TYPE_CLASSIFICATION_SYNC(2004L, "Big Id Data Type Classification Sync")
	, BIG_ID_DATA_ASSET_CLASSIFICATION_SYNC(2005L, "Big Id Data Asset Classification Sync")
	, BIG_ID_ROOT_ORGANIZATION_SYNC(2006L, "Big Id Root Organization Sync")
	, BIG_ID_SUB_ORGANIZATION_SYNC(2007L, "Big Id Sub Organization Sync")
