...
public class Systems implements IEntityWithMetadata, IMetadataAware<SystemsMetadata> {
	@Id
	...
	private DataAssetClassification dataAssetClassification;

	@ManyToMany(cascade = {CascadeType.DETACH}, fetch = FetchType.LAZY)
	@JoinTable(
		name = "data_domain_to_system",
	...
	@ManyToMany(cascade = {CascadeType.DETACH}, fetch = FetchType.LAZY)
	@JoinTable(
		name = "cybersecurity_tool_to_system",
		joinColumns = {@JoinColumn(name = "system_id")},
		inverseJoinColumns = {@JoinColumn(name = "cybersecurity_tool_id")}
	)
	private Set<CybersecurityTools> cybersecurityTools = new HashSet<>();
	...
	private Set<SystemGeoParameters> systemGeoParameters = new HashSet<>();
	...
	private Set<SystemsMetadata> metadata = new HashSet<>();
