...
/**
 * GDPR System Article Status Entity Definition
 *
 ...
 */
@Entity
@Table(name = "gdpr_system_article_status_log")
@NoArgsConstructor
@Setter
@Getter
@ToString(of = {"id", "system", "article", "compliance"})
@EqualsAndHashCode(of = {"id"})
public class GDPRSystemArticleStatusLog {
