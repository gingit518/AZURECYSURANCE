...
import com.cyberintech.vrisk.server.repository.jpa.UserPasswordResetLinksRepository;
...
public class UserPasswordResetLinksService {
	 ...
	 * @return
	 */
	public UserPasswordResetLinks create(Users user, Long expiration) {
