...
public class FieldClassifierMetadataViewDTO extends DTOBase<FieldClassifiersMetadata> {
	@Schema
	private Long id;
	@Schema
	private FieldClassifierRefDTO fieldClassifier;
	@Schema
	private String key;
	@Schema
	private String value;

	public FieldClassifierMetadataViewDTO(FieldClassifiersMetadata fieldClassifiersMetadata) {
	...
	public void fromEntity(FieldClassifiersMetadata fieldClassifiersMetadata) {
		...
		this.fieldClassifier = new FieldClassifierRefDTO(fieldClassifiersMetadata.getFieldClassifier());
