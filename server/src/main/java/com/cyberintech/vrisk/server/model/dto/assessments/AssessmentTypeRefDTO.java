...
/**
 * Assessment Type Reference Entity Definition
 *
...
public class AssessmentTypeRefDTO extends DTOBase<AssessmentTypes> {
	 ...
	 * @param entity
	 */
	public AssessmentTypeRefDTO(AssessmentTypes entity) {
		super(entity);
	}
