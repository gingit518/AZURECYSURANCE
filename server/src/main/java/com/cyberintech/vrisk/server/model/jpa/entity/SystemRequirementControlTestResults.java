 ...
 */
@Entity
@Table(name = "system_requirement_control_test_results")
@NoArgsConstructor
@Setter
@Getter
@ToString(of = {"id", "securityRequirement", "assessmentWeight"})
@EqualsAndHashCode(of = {"id"})
public class SystemRequirementControlTestResults {
	...
	private SystemControlTestResults systemControlTestResult;

	@ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
	@JoinTable(
		name = "system_requirement_control_test_result_to_task",
		joinColumns = {@JoinColumn(name = "system_control_test_result_id")},
	...
	@ManyToMany(fetch = FetchType.LAZY, cascade = {CascadeType.ALL})
	@JoinTable(
		name = "security_audit_comment_to_system_requirement_control_test_resul",
		joinColumns = {@JoinColumn(name = "system_requirement_control_test_result_id")},
